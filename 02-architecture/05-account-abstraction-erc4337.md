...
> 7702 是对 4337 的**补充而非替代**——4337 让账户可编程，7702 让数亿存量 EOA 不换地址就能接入。完整的机制、与 4337 的组合用法、以及它引入的新安全风险（恶意委托、双重控制权等），见本章专文 [12-eip-7702-deep-dive.md](./12-eip-7702-deep-dive.md)。
